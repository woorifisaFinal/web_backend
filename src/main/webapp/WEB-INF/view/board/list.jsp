	...
	<main id="main" class="main">
	    ...
	    <div class="col-10">
		    <div class="d-flex justify-content-between" style="border-bottom: 2px solid blue;">
		      <div><img class="mb-3" id="square" src="${pageContext.request.contextPath}/img/bluebox.jpg" alt="이미지 교체중입니다.">&nbsp;<h2 style="display: inline-block" class="fs-2 fw-bold" >공지사항</h2> </div>
		...
		<div id="body" class="col-10" style="background-color: bisque">
		    <table class="table">
		        <thead>
		            <tr>
		                <th scope="col">No</th>
		 ...
		 <!-- Create Button -->
	    <a href="/board/regist">Create</a>
	
	    <!-- Pagination Links -->
	    <ul>
	        <li><a href="?page=1">First</a></li>
	        <li><a href="?page=${pageInfo.number}">Previous</a></li>
	        <li><a href="?page=${pageInfo.number + 2}">Next</a></li>
	        <li><a href="?page=${pageInfo.totalPages}">Last</a></li>
	    </ul>
	</main>
